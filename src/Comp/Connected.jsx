...
const Connected = () => {
  return (
    <div className="relative pt-[80px] lg:pt-[100px] pb-[80px] lg:pb-[120px] bg-[linear-gradient(180deg,_#dedede00_0%,_#174aff4d_100%)] rounded-[30px] lg:bg-none bg-cover">
      ...
      <div className="px-[38px]">
        <div className="absolute tabsolute top-[50%] lg:top-[58%] left-1/2 transform -translate-x-[100px] lg:-translate-x-[600px] -translate-y-1/2 font-['Poppins'] overflow-hidden px-[24px] py-[40px]">
          <div>
